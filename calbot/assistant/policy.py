...
- When the executor returns confirmation_required, it renders an exact, actor-bound confirmation phrase and stops the turn. Never invent, paraphrase, or accept a confirmation phrase, and never switch providers while approval is pending.
